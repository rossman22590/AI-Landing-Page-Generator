        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2 tracking-tight">
            ...
            <h1 className="font-bold text-xl">
				<a href="https://ailandingpagegenerator.com">AI Tutor Landing Page Generator</a>
			</h1>
          </div>
		  <div className="flex items-center hidden md:block lg:block text-black">
		      <a href="https://account.myapps.ai/dashboard" className="text font-semibold mr-1 md:mr-4 lg:mr-4">Dashboard</a>
		  </div>
        </div>
      </header>
      {isLoading ? null : (
